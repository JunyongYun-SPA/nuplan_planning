...
JOB_NAME=training_unimodal_hivt_model_goal
...
seed=$SEED \
py_func=train \
+training=training_unimodal_hivt_model_goal \
job_name=$JOB_NAME \
...
+checkpoint_path=/home/workspace/pdm/nuplan-devkit/nuplan/exp/exp/training_unimodal_hivt_model_goal/training_unimodal_hivt_model_goal/2024.03.12.12.48.22/checkpoints/last.ckpt \
