...
parser.add_argument('--name', type=str, required=False, default='train_hivt_unimodal_model_BEV_feature_baseline')
parser.add_argument('--version', type=str, default='1')
parser.add_argument('--hidden_dim', type=int, required=False, default=64) #JY
parser.add_argument('--batch_size', type=int, required=False, default=32)
parser.add_argument('--resolution', type=int, required=False, default=100)
parser.add_argument('--map_channel_dimension', type=int, required=False, default=15)
parser.add_argument('--iterative_centerline', type=bool, required=False, default=False) 
parser.add_argument('--occupied_area', type=bool, required=False, default=False) #JY
parser.add_argument('--pos_emb', type=str, required=False, default='learnable') #JY
parser.add_argument('--agent_temporal_pos_emb', type=bool, required=False, default=False) #JY
parser.add_argument('--additional_state', type=bool, required=False, default=False) #JY
parser.add_argument('--multimodal', type=bool, required=False, default=False) #JY
parser.add_argument('--cnn', type=str, required=False, default='default') #JY
