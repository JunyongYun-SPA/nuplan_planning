...
CHECKPOINT='/home/workspace/dataset/nuplan/exp/exp/training_hivt_py/training_hivt_py/ver5_GTGoal/last_GTGoal.ckpt'
PLANNER = 'hivt_unimodal_120m_v4_0406_ver5_GTGoal'
...
cfg = hydra.compose(config_name=CONFIG_NAME, overrides=[
    ...
    f'planner={PLANNER}',
    'worker=ray_distributed', #ray_distributed
