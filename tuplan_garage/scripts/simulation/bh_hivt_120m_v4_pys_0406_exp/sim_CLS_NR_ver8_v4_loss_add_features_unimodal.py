...
SPLIT='reduced_val14_split_v2' #reduced_val14_split_v2 val14_split
CHALLENGE = 'closed_loop_nonreactive_agents' # open_loop_boxes, closed_loop_nonreactive_agents, closed_loop_reactive_agents
CHECKPOINT='/home/workspace/dataset/nuplan/exp/exp/training_hivt_py/training_hivt_py/train_hivt_unimodal_model_120m_goal_ver8_v4_add_features/2024.04.23.06.10.29/checkpoints/last.ckpt'
PLANNER = 'hivt_unimodal_120m_v4_0406_ver8_v4_add_features'
...
cfg = hydra.compose(config_name=CONFIG_NAME, overrides=[
    ...
    f'planner={PLANNER}',
    'worker=ray_distributed', #ray_distributed #sequential
...
# cfg.scenario_filter.limit_total_scenarios = 12
