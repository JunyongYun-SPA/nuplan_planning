...
class HiVTFeatureBuilder(AbstractFeatureBuilder): #JY
    ...
    def _compute_feature(
        ...
        (lane_vectors, is_intersections, turn_directions, traffic_controls, lane_actor_index,
         lane_actor_vectors, lane_positions, goals, in_route_lanes) = self.get_lane_features(current_input, 
    ...
    def get_lane_features(self, current_input, map_api, node_inds, node_positions, origin, rot_mat, radius, end_lanes, av_index, planner_centerline):
