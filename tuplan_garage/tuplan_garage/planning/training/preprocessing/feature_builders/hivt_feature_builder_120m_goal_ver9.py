...
class HiVTFeatureBuilder(AbstractFeatureBuilder): #JY
    ...
    def _compute_feature(
        ...
        (lane_vectors, is_intersections, turn_directions, traffic_controls, traffic_controls_red, lane_actor_index,
         lane_actor_vectors, lane_positions, goals, in_route_lanes) = self.get_lane_features(current_input, initialization.map_api, node_inds, node_positions, origin, rotate_mat, radius, end_lanes, start_lanes, av_index=actor_ids.index('ego'))
    ...
    def get_lane_features(self, current_input, map_api, node_inds, node_positions, origin, rot_mat, radius, end_lanes, start_lanes, av_index):
        lane_positions, lane_vectors, is_intersections, turn_directions, traffic_controls, traffic_controls_red, goals, lane_centerlines, in_route_lanes = [], [], [], [], [], [], [], [], []
        lane_ids = set()
        lane_con_ids = set()
        ...
        return lane_vectors, is_intersections, turn_directions, traffic_controls, traffic_controls_red, lane_actor_index, lane_actor_vectors, lane_positions, goals, in_route_lanes
