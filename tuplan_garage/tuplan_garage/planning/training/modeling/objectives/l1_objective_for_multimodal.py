...
class L1Objective(AbstractObjective):
    ...
    def compute(
        ...
        """
        predicted_trajectory = predictions["trajectory"][:, :, :2] #[targets['pdm_features']['av_index'], :, :2]
        targets_trajectory = targets['pdm_features']['y'][:, :16:, :2] #[targets['pdm_features']['av_index'], :16, :2]
