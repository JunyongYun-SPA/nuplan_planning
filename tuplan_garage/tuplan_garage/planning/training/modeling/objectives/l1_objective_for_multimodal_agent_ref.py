...
class L1ObjectiveAgent(AbstractObjective):
    ...
    def __init__(
        ...
        """
        self._name = "l1_objective_agent_ref"
        self._weight = weight
    ...
    def compute(
        ...
        batch_size = predicted_trajectory_ref.shape[0]
        ...
        # cls_loss = self._cls_loss_function(predictions['pi_ref'][~av_mask, :][cls_mask, :], targets['soft_target_ref'][~av_mask, :][cls_mask, :])
        loss = torch.mean(loss) #+ cls_loss
