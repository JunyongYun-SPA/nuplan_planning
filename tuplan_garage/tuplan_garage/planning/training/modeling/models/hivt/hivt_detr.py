...
from tuplan_garage.planning.training.modeling.models.hivt.occ_generator import OccGenerator, OccupancyGeneratorParallel, OccupancyGenerator, apply_gaussian_kernel, GaussianOccupancyGT
...
class HiVTModel(TorchModuleWrapper): #JY
    ...
    def __init__(
        ...
        self.occ_generator = OccGenerator(historical_steps=11,
                                          node_dim=2,
                                          edge_dim=2,
                                          embed_dim=64,
                                          num_heads=8,
    ...
    def forward(self, features: FeaturesType) -> TargetsType:
        ...
        input['occupancy_map'] = occupancy_map_gt
        
        generated_occupancy_map = self.occ_generator(input, occupancy_map) #occpancy_map 예측
