...
from tuplan_garage.planning.training.modeling.models.hivt.occ_generator import *
from tuplan_garage.planning.training.modeling.models.hivt.unet import *
import numpy as np
...
class HiVTModel(TorchModuleWrapper): #JY
    ...
    def forward(self, features: FeaturesType) -> TargetsType:
        ...
        occupancy_map, occupancy_map_gt = OccupancyGeneratorParallelAddLaneType(input, y_hat, pi) #occpancy map 생성 (key, value로 사용예정)
        
        generated_occupancy_map = self.unet(occupancy_map)
        
        # blurred_occupancy_map_gt = GaussianOccupancyGT(occupancy_map_gt)
        blurred_occupancy_map_gt = occupancy_map_gt
