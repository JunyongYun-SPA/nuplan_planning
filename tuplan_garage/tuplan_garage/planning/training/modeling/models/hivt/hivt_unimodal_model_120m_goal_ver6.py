...
from tuplan_garage.planning.training.preprocessing.feature_builders.hivt_feature_builder_50m_goal_ver4 import (
    HiVTFeatureBuilder,
)
...
from tuplan_garage.planning.training.modeling.models.hivt.local_encoder_120m_goal_ver6 import LocalEncoder
    ...
    def forward(self, features: FeaturesType) -> TargetsType:
        ...
        if self.rotate:
            ...
            if input.y is not None:
                ...
                # input.y[:,:,2] = input.y[:,:,2] - input['rotate_angles'].unsqueeze(1) #
            input['rotate_mat'] = rotate_mat
        else:
            input['rotate_mat'] = None

        input["positions"] = input["positions"][...,:2]
