...
from tuplan_garage.planning.training.modeling.models.hivt.hivt_utils import DistanceDropEdge
...
class LocalEncoder(nn.Module):
    ...
    def __init__(self,
        ...
        self.drop_edge_al_av = GetInRouteLaneEdgeRoute(local_radius)
        self.drop_edge_al_agent = DistanceDropEdge(local_radius)
    ...
    def forward(self, data: TemporalData) -> torch.Tensor:
        ...
        edge_index, edge_attr = self.drop_edge_al_agent(data['lane_actor_index'], data['lane_actor_vectors'])
        ...
        edge_index, edge_attr = self.drop_edge_al_av(data['lane_actor_index'], data['lane_actor_vectors'], data['av_index'], data['in_route_lanes'])
        out_av = self.al_encoder_av(x=(data['lane_vectors'], out_agent), edge_index=edge_index, edge_attr=edge_attr,
                              is_intersections=data['is_intersections'], turn_directions=data['turn_directions'],
