...
from tuplan_garage.planning.training.modeling.models.hivt.hivt_utils import *
from tuplan_garage.planning.training.modeling.models.hivt.hivt_utils import GetInRouteLaneEdgeTotal
...
class LocalEncoder(nn.Module):
    ...
    def __init__(self,
        ...
        self.drop_edge_al = GetInRouteLaneEdgeTotal(local_radius)
        ...
        self.al_encoder = ALEncoderGoal(node_dim=node_dim,
                                    edge_dim=edge_dim,
                                    embed_dim=embed_dim,
                                    num_heads=num_heads,
                                    dropout=dropout)
    ...
    def forward(self, data: TemporalData) -> torch.Tensor:
        ...
        # edge_index, edge_attr = self.drop_edge_al(data['lane_actor_index'], data['lane_actor_vectors'], data['av_index'], data['in_route_lanes'])
        ...
        #                       traffic_controls=data['traffic_controls'], goals=data['goal'], rotate_mat=data['rotate_mat'])
        ...
        out_av = self.al_encoder(x=(data['lane_vectors'], out), edge_index=edge_index, edge_attr=edge_attr,
                              is_intersections=data['is_intersections'], turn_directions=data['turn_directions'],
                              traffic_controls=data['traffic_controls'], goals=data['goal'], rotate_mat=data['rotate_mat'])
