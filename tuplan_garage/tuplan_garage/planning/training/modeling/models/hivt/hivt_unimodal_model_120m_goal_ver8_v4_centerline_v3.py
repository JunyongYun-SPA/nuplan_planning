...
from tuplan_garage.planning.training.modeling.models.hivt.local_encoder_120m_goal_ver8_v4_centerline_v3 import LocalEncoder
...
class HiVTModel(TorchModuleWrapper): #JY
    ...
    def forward(self, features: FeaturesType) -> TargetsType:
        ...
        y_hat = input["y"].new_zeros(self.num_modes, input["y"].shape[0], input["y"].shape[1], input["y"].shape[2])
        ...
        y_hat[:, av_mask], pi[av_mask] = y_hat_av, pi_av
        y_hat[:, other_agent_mask], pi[other_agent_mask] = y_hat_agent, pi_agent
