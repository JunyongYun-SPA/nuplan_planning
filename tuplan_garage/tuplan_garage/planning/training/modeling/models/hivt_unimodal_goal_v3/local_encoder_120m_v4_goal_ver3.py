...
from tuplan_garage.planning.training.modeling.models.hivt.hivt_utils import GetInRouteLaneEdgeTotal, GetInRouteLaneEdgeRoute, GetInRouteLaneEdgeGoalPoint
...
class LocalEncoder(nn.Module):
    ...
    def __init__(self,
        ...
        self.drop_edge_al = GetInRouteLaneEdgeGoalPoint(local_radius)
    ...
    def forward(self, data: TemporalData) -> torch.Tensor:
        ...
        edge_index, edge_attr = self.drop_edge_al(data['lane_actor_index'], data['lane_actor_vectors'], data['av_index'], data['goal'])
