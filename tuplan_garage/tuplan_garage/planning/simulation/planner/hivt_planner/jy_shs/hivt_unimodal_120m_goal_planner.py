...
#     create_pdm_feature,
# )
from tuplan_garage.planning.simulation.planner.hivt_planner.utils.hivt_120m_goal_feature_utils import (
    create_hivt_feature,
)
...
class HivtUnimodal(AbstractPDMPlanner):
    ...
    def compute_planner_trajectory(
        ...
        current_ego_vel = current_input.history.current_state[0].dynamic_car_state.speed
