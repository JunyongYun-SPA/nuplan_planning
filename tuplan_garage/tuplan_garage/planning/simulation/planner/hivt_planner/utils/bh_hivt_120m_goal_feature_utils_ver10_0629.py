...
def get_lane_features(current_input, map_api, node_inds, node_positions, origin, rot_mat, radius, end_lanes,start_lanes, centerline_lanes, planner_centerline):
    ...
    return lane_vectors, is_intersections, turn_directions, traffic_controls, lane_actor_index, lane_actor_vectors, lane_positions, goals, in_route_lanes, in_centerline_lanes, in_centerline
...
def create_hivt_feature(
    ...
    (lane_vectors, is_intersections, turn_directions, traffic_controls, lane_actor_index,
        lane_actor_vectors, lane_positions, goals, in_route_lanes, in_centerline_lanes, in_centerline) = get_lane_features(planner_input, initialization.map_api, node_inds, node_positions, origin, rotate_mat, radius, end_lanes, start_lanes, centerline_lanes, planner_centerline)
