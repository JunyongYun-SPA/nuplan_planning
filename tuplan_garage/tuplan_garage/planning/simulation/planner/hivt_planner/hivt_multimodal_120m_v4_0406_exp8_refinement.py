...
#     create_pdm_feature,
# )
from tuplan_garage.planning.simulation.planner.hivt_planner.utils.bh_hivt_120m_goal_feature_utils_ver8 import (
    create_hivt_feature,
)
...
class HivtUnimodal(AbstractPDMPlanner):
    ...
    def compute_planner_trajectory(
        ...
        y_hat = predictions["trajectory_ref"][:,temporal_feature['av_index'],:, :3].detach()
