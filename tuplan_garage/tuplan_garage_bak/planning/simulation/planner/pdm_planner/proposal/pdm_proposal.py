...
class PDMProposalManager:
    ...
    def __init__(
        ...
        self._num_lateral_proposals: int = len(lateral_proposals) # 3
        self._num_longitudinal_proposals: int = longitudinal_policies.num_policies # 5
        self._longitudinal_policies: BatchIDMPolicy = longitudinal_policies # idm policy object
