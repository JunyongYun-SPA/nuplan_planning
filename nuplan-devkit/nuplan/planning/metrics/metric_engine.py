...
class MetricsEngine:
    ...
    def write_to_files(self, metric_files: Dict[str, List[MetricFile]]) -> None:
        ...
        for scenario_name, metric_files in metric_files.items():  # type: ignore
            ...
            # bh_file_name = scenario_name + BH_FILE_EXTENTION 
            save_path = self._main_save_path / file_name
            # bh_save_path = self._main_save_path / bh_file_name
            dataframes = []
            ...
            if len(dataframes):
                ...
                # save_object_as_pickle(bh_save_path, dataframes)

    def compute_metric_results(
        self, history: SimulationHistory, scenario: AbstractScenario, save_path
    ...
    def compute(
        ...
        """
        all_metrics_results = self.compute_metric_results(history=history, scenario=scenario, save_path=self._main_save_path)
