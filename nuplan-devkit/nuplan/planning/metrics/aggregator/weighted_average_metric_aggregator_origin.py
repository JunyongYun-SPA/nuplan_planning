...
class WeightedAverageMetricAggregator(AbstractMetricAggregator):
    ...
    def __init__(
        ...
        """
        self._name = name
        # metric_weights["ego_is_comfortable"] = 0.0
        # metric_weights["ego_progress_along_expert_route"] = 1.0
        # metric_weights["speed_limit_compliance"] = 0.0
        # metric_weights["time_to_collision_within_bound"] = 0.0
