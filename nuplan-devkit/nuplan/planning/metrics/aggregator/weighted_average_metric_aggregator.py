...
class WeightedAverageMetricAggregator(AbstractMetricAggregator):
    ...
    def __init__(
        ...
        """
        self._name = name
        metric_weights_manual = dict()
        # metric_weights_manual["ego_is_comfortable"] = 1.0
        # metric_weights_manual["ego_progress_along_expert_route"] = 1.0
        # metric_weights_manual["speed_limit_compliance"] = 1.0
        metric_weights_manual["time_to_collision_within_bound"] = 1.0
        metric_weights_manual["ego_is_comfortable"] = 1.0
        metric_weights_manual["speed_limit_compliance"] = 1.0
        metric_weights_manual["planner_expert_average_l2_error_within_bound"] = 3.0
        # metric_weights_manual["planner_expert_final_l2_error_within_bound"] = 2.0
        metric_weights_manual["planner_expert_average_heading_error_within_bound"] = 3.0
        self._metric_weights = metric_weights_manual
        ...
        multiple_metrics = ["no_ego_at_fault_collisions", "drivable_area_compliance", "driving_direction_compliance"]
