...
class PlannerMissRateStatistics(MetricBase):
    ...
    def compute(self, history: SimulationHistory, scenario: AbstractScenario) -> List[MetricStatistics]:
        ...
        maximum_displacement_errors = (
            self._planner_expert_average_l2_error_within_bound_metric.maximum_displacement_errors # (3,15) 각 시점에서 최고값
        )
        comparison_horizon = self._planner_expert_average_l2_error_within_bound_metric.comparison_horizon #[3, 5, 8]
