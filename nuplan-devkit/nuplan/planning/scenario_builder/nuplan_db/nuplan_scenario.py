...
class NuPlanScenario(AbstractScenario):
    ...
    def __init__(
        ...
        #BH 강제 루트 설정
        data_root = "/home/workspace/dataset/nuplan-v1.1/trainval"
        # data_root = "/home/workspace/dataset/nuplan-v1.1/splits/mini"
        map_root = "/home/workspace/dataset/maps"
        log_file_load_path = os.path.join(data_root, log_file_load_path.split("/")[-1])
